...
/** CUP v0.10k generated parser.
  * @version Mon Dec 22 18:02:26 CET 2014
  */
    ...
    throws java.lang.Exception
    {
      ...
      switch (CUP$MyParser$act_num)
		...
		TypeNode expr = (TypeNode)((java_cup.runtime.Symbol) CUP$MyParser$stack.elementAt(CUP$MyParser$top-2)).value;
         ...
         if (expr.typeKind != TypeNode.Bool)
         {
             System.out.println(parser.getErrorLine() + "Loop expression does not evaluate to bool: "
             + expr.name + " provided.");
             parser.errNo++;
         }
         RESULT = parser.symbolTable.getType("bool");
          ...
          case 22: // StatementList ::= Statement 
            {
              Object RESULT = null;
                ...
                //parser.symbolTable.activeScope++;
                //parser.debug("StatementListTail");
          ...
          case 21: // StatementList ::= StatementList Statement 
            {
              Object RESULT = null;
                  ...
                  //parser.symbolTable.activeScope++;
                //parser.debug("StatementListRecursive");
		...
		TypeNode t = (TypeNode)((java_cup.runtime.Symbol) CUP$MyParser$stack.elementAt(CUP$MyParser$top-1)).value;
          ...
          case 8: // VarList ::= VarDecl 
            ...
            //parser.debug("VarListTail");
            parser.symbolTable.firstStatement = true;
